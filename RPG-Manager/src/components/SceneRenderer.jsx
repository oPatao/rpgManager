              ...
              return (
                <div className="absolute bottom-12 right-[5%] w-[45%] z-20 pointer-events-none animate-fade-in-up">
                  ...
                  >
                    ...
                    {role === 'master' && !isPreview && singleNpc.desc && (
                      <div className="mt-3 pt-3 border-t border-slate-700/60">
                        <span className="text-[10px] uppercase font-bold tracking-wider text-amber-500/80 block mb-1">
                          Descrição Oculta (Apenas Mestre)
                        </span>
                        <p className="text-slate-300 text-base md:text-lg leading-relaxed italic border-l-2 border-amber-600/60 pl-3 whitespace-pre-wrap">
                          "{singleNpc.desc}"
                        </p>
                      </div>
                    )}
